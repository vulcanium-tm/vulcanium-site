...
var On = Object.assign, $t = Object.getOwnPropertyDescriptor, W = Object.defineProperty, Mt = Object.prototype, Dt = [];
Object.freeze(Dt);
var br = {};
Object.freeze(br);
...
function Tn(e, t, r, n, i, o) {
  o === void 0 && (o = h.safeDescriptors), Oo(e, t, r, n);
  var a = n.value;
  if (Qe(a) || (a = Re(a)), i) {
    var l;
...
var lr = /* @__PURE__ */ Ht(ko), Uo = /* @__PURE__ */ Ht(Lo, {
  enhancer: Kt
}), Bo = /* @__PURE__ */ Ht(Io, {
  enhancer: ho
}), zo = /* @__PURE__ */ Ht(Mo, {
...
function _t(e) {
  return e.deep === !0 ? ge : e.deep === !1 ? Kt : Ho(e.defaultDecorator);
}
function Ko(e) {
  var t;
...
}, w = /* @__PURE__ */ On(kn, qo), Ln = "computed", Fo = "computed.struct", cr = /* @__PURE__ */ Or(Ln), Wo = /* @__PURE__ */ Or(Fo, {
...
function ur(e) {
  switch (e.dependenciesState_) {
    ...
    case b.POSSIBLY_STALE_: {
      for (var t = Ar(!0), r = Se(), n = e.observing_, i = n.length, o = 0; o < i; o++) {
        var a = n[o];
        if (Gt(a)) {
...
function ra(e) {
  ...
  for (r.length = i, e.newObserving_ = null, o = t.length; o--; ) {
    var s = t[o];
    s.diffValue_ === 0 && Hn(s, e), s.diffValue_ = 0;
  }
  for (; i--; ) {
    var c = r[i];
...
function Hn(e, t) {
  e.observers_.delete(t), e.observers_.size === 0 && qn(e);
}
function qn(e) {
...
function Fn(e) {
  ...
  return t !== null ? (t.runId_ !== e.lastAccessedBy_ && (e.lastAccessedBy_ = t.runId_, t.newObserving_[t.unboundDepsCount_++] = e, !e.isBeingObserved_ && h.trackingContext && (e.isBeingObserved_ = !0, e.onBO())), e.isBeingObserved_) : (e.observers_.size === 0 && h.inBatch > 0 && qn(e), !1);
}
function Wn(e) {
...
function ei(e, t) {
  var r, n, i, o, a;
  t === void 0 && (t = br), process.env.NODE_ENV !== "production" && (O(e) || v("Autorun expects a function as first argument"), dt(e) && v("Autorun does not accept actions since actions are untrackable"));
...
function ri(e, t, r) {
  var n, i, o, a;
  r === void 0 && (r = br), process.env.NODE_ENV !== "production" && ((!O(e) || !O(t)) && v("First and second argument to reaction should be functions"), D(r) || v("Third argument of reactions should be an object"));
  ...
  function S() {
    if (f = !1, !m.isDisposed_) {
      ...
      m.track(function() {
        ...
        q = u || !y(p, ee), p = ee;
      }), (u && r.fireImmediately || !u && q) && s(p, xe, m), u = !1;
    }
  }
...
var Qt = /* @__PURE__ */ Cn("flow"), Oa = /* @__PURE__ */ Cn("flow.bound", {
  bound: !0
  ...
  var n = t, i = n.name || "<unnamed flow>", o = function() {
    var l = this, s = arguments, c = ++Ea, d = de(i + " - runid: " + c + " - init", n).apply(l, s), u, f = void 0, p = new Promise(function(y, m) {
      var S = 0;
      u = m;
      function q(P) {
        f = void 0;
      ...
      function ee(P) {
        ...
        return P.done ? y(P.value) : (f = Promise.resolve(P.value), f.then(q, xe));
      }
      q(void 0);
    });
...
function Aa(e, t) {
  return e ? t !== void 0 ? process.env.NODE_ENV !== "production" && (Q(e) || ft(e)) ? v("isObservable(object, propertyName) is not supported for arrays and maps. Use map.has or array.length instead.") : ye(e) ? e[g].values_.has(t) : !1 : ye(e) || !!e[g] || Er(e) || Vt(e) || Gt(e) : !1;
}
function et(e) {
  return process.env.NODE_ENV !== "production" && arguments.length !== 1 && v("isObservable expects only 1 argument. Use isObservableProp to inspect the observability of a property"), Aa(e);
}
function wa() {
  if (process.env.NODE_ENV !== "production") {
...
function xa(e, t) {
  var r, n;
  return An(), e = Me(e, t), (n = (r = e[g]).proxy_) != null ? n : r.proxy_ = new Proxy(e, Na);
}
function R(e) {
...
var qr = "splice", U = "update", $a = 1e4, Da = {
  get: function(t, r) {
    var n = t[g];
...
function Pa(e, t, r, n) {
  return r === void 0 && (r = process.env.NODE_ENV !== "production" ? "ObservableArray@" + M() : "ObservableArray"), n === void 0 && (n = !1), An(), Ne(function() {
  ...
  return t.has_ = function(n) {
    ...
    return J(function() {
      ...
      for (var p = Te(o.entries()), y; !(y = p()).done; ) {
        var m = y.value, S = m[0], q = m[1], xe = i.data_.has(S);
...
var fi = /* @__PURE__ */ function() {
  function e(r, n, i) {
    var o = this;
    n === void 0 && (n = ge), i === void 0 && (i = process.env.NODE_ENV !== "production" ? "ObservableSet@" + M() : "ObservableSet"), this.name_ = void 0, this[g] = Ra, this.data_ = /* @__PURE__ */ new Set(), this.atom_ = void 0, this.changeListeners_ = void 0, this.interceptors_ = void 0, this.dehancer = void 0, this.enhancer_ = void 0, this.name_ = i, O(Set) || v(22), this.enhancer_ = function(a, l) {
      return n(a, l, i);
    }, Ne(function() {
...
var xr = /* @__PURE__ */ function(e, t, r) {
  ...
  function n(o, a, l, s) {
    ...
    return l === void 0 && (l = process.env.NODE_ENV !== "production" ? "ObservableArray@" + M() : "ObservableArray"), s === void 0 && (s = !1), c = e.call(this) || this, Ne(function() {
      ...
      d.proxy_ = At(c), Sn(At(c), g, d), o && o.length && c.spliceWithArray(0, 0, o), La && Object.defineProperty(At(c), "0", ka);
    }), c;
  }
  var i = n.prototype;
...
const rt = "copilot-", Ka = "24.4.0", fl = "attention-required", pl = "https://plugins.jetbrains.com/plugin/23758-vaadin", gl = "https://marketplace.visualstudio.com/items?itemName=vaadin.vaadin-vscode", _l = (e, t, r) => t >= e.left && t <= e.right && r >= e.top && r <= e.bottom, Ha = (e) => {
  const t = [];
  let r = Fa(e);
  for (; r; )
...
function nt(e) {
  return !e || !(e instanceof HTMLElement) ? !1 : [...Ha(e), e].map((t) => t.localName).some((t) => t.startsWith(rt));
}
function bl(e) {
...
const ze = {
  ...
  e.addEventListener("focusout", yi, { capture: !0 }), Ei(e), e.opened = !0;
}, mt = (e) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Vr = globalThis, Lt = Vr.trustedTypes, sn = Lt ? Lt.createPolicy("lit-html", { createHTML: (e) => e }) : void 0, Rr = "$lit$", Z = `lit$${(Math.random() + "").slice(9)}$`, jr = "?" + Z, ds = `<${jr}>`, Ee = document, it = () => Ee.createComment(""), ot = (e) => e === null || typeof e != "object" && typeof e != "function", xi = Array.isArray, $i = (e) => xi(e) || typeof e?.[Symbol.iterator] == "function", rr = `[ 	
\f\r]`, Ke = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, ln = /-->/g, cn = />/g, se = RegExp(`>|${rr}(?:([^\\s"'>=/]+)(${rr}*=${rr}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), un = /'/g, dn = /"/g, Di = /^(?:script|style|textarea|title)$/i, Pi = (e) => (t, ...r) => ({ _$litType$: e, strings: t, values: r }), _r = Pi(1), xl = Pi(2), Oe = Symbol.for("lit-noChange"), A = Symbol.for("lit-nothing"), hn = /* @__PURE__ */ new WeakMap(), he = Ee.createTreeWalker(Ee, 129);
function Ci(e, t) {
...
class Ue {
  ...
  _$AI(t, r = this) {
    t = Ae(this, t, r), ot(t) ? t === A || t == null || t === "" ? (this._$AH !== A && this._$AR(), this._$AH = A) : t !== this._$AH && t !== Oe && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : $i(t) ? this.k(t) : this._(t);
  }
  S(t) {
  ...
  _(t) {
    this._$AH !== A && ot(this._$AH) ? this._$AA.nextSibling.data = t : this.T(Ee.createTextNode(t)), this._$AH = t;
  }
  $(t) {
...
class pt {
  ...
  _$AI(t, r = this, n, i) {
    ...
    let a = !1;
    if (o === void 0)
      t = Ae(this, t, r, 0), a = !ot(t) || t !== this._$AH && t !== Oe, a && (this._$AH = t);
    else {
      const l = t;
      let s, c;
      for (t = o[0], s = 0; s < o.length - 1; s++)
        c = Ae(this, l[n + s], r, s), c === Oe && (c = this._$AH[s]), a ||= !ot(c) || c !== this._$AH[s], c === A ? t = A : t !== A && (t += (c ?? "") + o[s + 1]), this._$AH[s] = c;
    }
    a && !i && this.j(t);
  }
  j(t) {
...
const hs = { P: Rr, A: Z, C: jr, M: 1, L: Ti, R: Vi, D: $i, V: Ae, I: Ue, H: pt, N: ji, U: ki, B: Ri, F: Li }, vs = Vr.litHtmlPolyfillSupport;
...
function ms() {
  ue.push(import("./copilot-log-plugin-CkB0WgJq.js")), ue.push(import("./copilot-info-plugin-C2S0MdHi.js")), ue.push(import("./copilot-features-plugin-C9JHnuU5.js")), ue.push(import("./copilot-feedback-plugin-BO8lyxwF.js")), ue.push(import("./copilot-shortcuts-plugin-2T1sOte3.js"));
}
function ys() {
  {
...
class Os {
  constructor() {
    this.active = !1, this.activate = () => {
      ...
      this.active && (nt(t.target) || (t.target.blur && t.target.blur(), document.body.querySelector("copilot-main")?.focus()));
    };
  }
...
const yt = new Os(), $ = window.Vaadin.copilot.eventbus;
if (!$)
  throw new Error("Tried to access copilot eventbus before it was initialized.");
const He = window.Vaadin.copilot.overlayManager, Dl = {
...
}, As = async (e, t, r) => window.Vaadin.copilot.comm(e, t, r);
var Mi = /* @__PURE__ */ ((e) => (e.INFORMATION = "information", e.WARNING = "warning", e.ERROR = "error", e))(Mi || {});
function ws() {
  return import("./copilot-notification-BtXneIoV.js");
}
function Ui(e, t) {
...
}, Ss = async () => As(`${rt}get-user-info`, {}, (e) => (delete e.data.reqId, e.data)), Ns = async () => wi(() => _.userInfo), Pl = async () => (await Ns()).vaadiner;
...
}, Hi = (e) => ({ _$litStatic$: e, r: Ki }), gn = /* @__PURE__ */ new Map(), js = (e) => (t, ...r) => {
  const n = r.length;
  let i, o;
  const a = [], l = [];
  let s, c = 0, d = !1;
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { I: Ms } = hs, _n = () => document.createComment(""), qe = (e, t, r) => {
  ...
  update(e, [t, r, n]) {
    ...
    for (; u <= f && p <= y; )
      if (i[u] === null)
        ...
        s[y] = le(i[u], o[y]), qe(e, s[y + 1], i[u]), u++, y--;
      else if (l[f] === a[p])
        s[p] = le(i[f], o[p]), qe(e, i[u], i[f]), f--, p++;
        ...
        if (c.has(l[f])) {
          ...
          if (S === null) {
            ...
            s[p] = le(S, o[p]), qe(e, i[u], S), i[m] = null;
          p++;
        } else
          ir(i[f]), f--;
      else
...
let yn = class extends _s {
  constructor() {
    super(...arguments), this.removers = [], this.initialized = !1, this.operationInProgressCursorUpdate = al(() => {
      this.toggleAttribute("operation-in-progress", _.operationWaitsHmrUpdate !== void 0);
    }, 500), this.overlayOutsideClickListener = (e) => {
  ...
  async init() {
    if (this.initialized)
      return;
    await window.Vaadin.copilot._machineState.initializer.promise, document.body.style.setProperty("--dev-tools-button-display", "none"), await import("./copilot-global-vars-later-D-zvxLiZ.js"), await import("./copilot-init-step2-I1aXeGPy.js"), ms(), this.tabIndex = 0, yt.hostConnectedCallback(), window.addEventListener("keydown", pn), $.onSend(this.handleSendEvent), this.removers.push($.on("close-drawers", this.closeDrawers.bind(this))), this.removers.push(
      $.on("open-attention-required-drawer", this.openDrawerIfPanelRequiresAttention.bind(this))
    ), this.addEventListener("mousemove", this.mouseMoveListener), this.addEventListener("dragover", this.mouseMoveListener), He.addOverlayOutsideClickEvent();
    ...
    this.classList.toggle("dark", e.matches), e.addEventListener("change", (t) => {
      ...
      () => {
        _.operationWaitsHmrUpdate ? this.operationInProgressCursorUpdate() : this.operationInProgressCursorUpdate.clear();
      }
   ...
   */
  activate() {
    Ii("activate"), yt.activate(), Es(), this.openDrawerIfPanelRequiresAttention(), document.documentElement.addEventListener("mouseleave", this.mouseLeaveListener), He.onCopilotActivation(), $.emit("component-tree-updated", {});
  }
  /**
   * Called when Copilot is deactivated. Good place to remove listeners etc.
   */
  deactivate() {
    this.closeDrawers(), yt.deactivate(), document.documentElement.removeEventListener("mouseleave", this.mouseLeaveListener), He.onCopilotDeactivation();
  }
  disconnectedCallback() {
    super.disconnectedCallback(), yt.hostDisconnectedCallback(), window.removeEventListener("keydown", pn), $.offSend(this.handleSendEvent), this.removers.forEach((e) => e()), this.removeEventListener("mousemove", this.mouseMoveListener), this.removeEventListener("dragover", this.mouseMoveListener), He.removeOverlayOutsideClickEvent(), document.documentElement.removeEventListener("vaadin-overlay-outside-click", this.overlayOutsideClickListener);
  }
  handleSendEvent(e) {
  ...
  render() {
    return _r`
      ...
      ${this.renderDrawer("left")} ${this.renderDrawer("right")} ${this.renderDrawer("bottom")} ${Hs()}
  ...
  closeDrawers() {
    ...
    const i = qa(n, "copilot-drawer-panel");
    if (!i) {
      e.forEach((o) => {
        o.opened = !1;
      });
