import { t as L, M as T, C as R, l as a, b as c, m as G, r as N, n as k, e as l, O as X, A as z, o as p, x as u, q as Z, u as S, w as U, T as C, y as K, z as J, B as Q, D as ee, E as te } from "./copilot-BwGYSCVE.js";
import { n as D, r as ie } from "./state-D4MdSqrt.js";
import { e as A, m as oe } from "./overlay-monkeypatch-B_ui42--.js";
import { i as P } from "./icons-RmKgnsAR.js";
import { o as ne } from "./unsafe-html-C-xRxXSj.js";
import { h as se } from "./react-utils-DFD62MFY.js";
import { dismissNotification as re, showNotification as ae } from "./copilot-notification-BtXneIoV.js";
/**
 * @license
...
let m = class extends T {
    ...
    super(...arguments), this.position = "right", this.opened = !1, this.keepOpen = !1, this.resizing = !1, this.closingForcefully = !1, this.draggingSectionPanel = null, this.activationAnimationTransitionEndListener = () => {
      ...
      e.stopPropagation(), e.preventDefault(), requestAnimationFrame(() => {
        ...
        if (this.position === "right") {
          ...
          this.style.setProperty("--size", `${i}px`), R.saveDrawerSize(this.position, i), o = { width: i };
        } else if (this.position === "left") {
          const i = t;
          this.style.setProperty("--size", `${i}px`), R.saveDrawerSize(this.position, i), o = { width: i };
        } else if (this.position === "bottom") {
          const i = document.body.clientHeight - n;
          this.style.setProperty("--size", `${i}px`), R.saveDrawerSize(this.position, i), o = { height: i };
        }
  ...
  mouseEnterListener(e) {
    this.closingForcefully || l.sectionPanelResizing || (this.opened = !0);
  }
  render() {
    return u`
...
class pe {
  ...
  adjust(t, n, o, i, r) {
    let s, d, h, w;
    const y = document.documentElement.getBoundingClientRect().width, x = document.documentElement.getBoundingClientRect().height;
    return (i + n) / 2 < y / 2 ? (t.style.setProperty("--left", `${n}px`), t.style.setProperty("--right", ""), w = void 0, s = Math.max(0, n)) : (t.style.removeProperty("--left"), t.style.setProperty("--right", `${y - i}px`), s = void 0, w = Math.max(0, y - i)), (o + r) / 2 < x / 2 ? (t.style.setProperty("--top", `${o}px`), t.style.setProperty("--bottom", ""), h = void 0, d = Math.max(0, o)) : (t.style.setProperty("--top", ""), t.style.setProperty("--bottom", `${x - r}px`), d = void 0, h = Math.max(0, x - r)), {
      left: s,
      right: w,
      top: d,
      bottom: h
        ...
        children: [
          {
            component: v("vaadin-menu-bar-item", {
              ...
              hint: p.isActivationShortcut() ? S.toggleCopilot : void 0
            }),
            action: "copilot"
          },
          {
...
let I = class extends T {
  constructor() {
    super(...arguments), this.panelTag = "", this.floatingResizingStarted = !1, this.resizingInDrawerStarted = !1, this.toggling = !1, this.rectangleBeforeResizing = null, this.floatingResizeHandlerMouseMoveListener = (e) => {
      ...
      if (n < s ? i < s ? (d = "nw-resize", this.setAttribute(g, "top left")) : r < s ? (d = "sw-resize", this.setAttribute(g, "bottom left")) : (d = "col-resize", this.setAttribute(g, "left")) : o < s ? i < s ? (d = "ne-resize", this.setAttribute(g, "top right")) : r < s ? (d = "se-resize", this.setAttribute(g, "bottom right")) : (d = "col-resize", this.setAttribute(g, "right")) : r < s ? (d = "row-resize", this.setAttribute(g, "bottom")) : i < s && (d = "row-resize", this.setAttribute(g, "top")), d !== "") {
        const h = window.getComputedStyle(this), w = Number.parseInt(h.borderTopWidth, 10), y = Number.parseInt(h.borderTopWidth, 10), x = Number.parseInt(h.borderLeftWidth, 10), V = Number.parseInt(h.borderRightWidth, 10);
        this.rectangleBeforeResizing = this.getBoundingClientRect(), this.rectangleBeforeResizing.width -= x + V, this.rectangleBeforeResizing.height -= w + y, this.style.setProperty("--resize-cursor", d);
      } else
      ...
      const { width: t, height: n } = this.getBoundingClientRect(), { left: o, top: i, bottom: r, right: s } = f.anchor(this), d = window.getComputedStyle(this), h = Number.parseInt(d.borderTopWidth, 10), w = Number.parseInt(d.borderTopWidth, 10), y = Number.parseInt(d.borderLeftWidth, 10), x = Number.parseInt(d.borderRightWidth, 10);
  ...
  getPopupButtonIcon() {
    return this.panelInfo ? this.panelInfo.panel === void 0 ? P.close : this.panelInfo.floating ? this.panelInfo.panel === "bottom" ? P.dockBottom : this.panelInfo.panel === "left" ? P.dockLeft : this.panelInfo.panel === "right" ? P.dockRight : C : P.popup : C;
  }
  renderActions() {
...
var we = Object.defineProperty, ye = Object.getOwnPropertyDescriptor, xe = (e, t, n, o) => {
  for (var i = o > 1 ? void 0 : o ? ye(t, n) : t, r = e.length - 1, s; r >= 0; r--)
    (s = e[r]) && (i = (o ? s(t, n, i) : s(i)) || i);
  return o && i && we(t, n, i), i;
};
...
H ? H.add((e, t) => {
  e === "loading" && t === "connected" && l.active && W();
