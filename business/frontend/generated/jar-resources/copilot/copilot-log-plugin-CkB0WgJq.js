import { B as d, l as E, D as c, x as l, F as k, h as D, G as R, M as C, b as M, H as T, t as w } from "./copilot-BwGYSCVE.js";
import { r as x } from "./state-D4MdSqrt.js";
import { B as S } from "./base-panel-Cn57eO3M.js";
import { i as n } from "./icons-RmKgnsAR.js";
...
let r = class extends S {
  ...
  updateLog(e) {
    ...
    if (!t) {
      D(`Unable to find message with id ${e.id}`);
      return;
    }
    Object.assign(t, e), R(t.expandedDetails) && (t.expandedDetails = d(t.expandedDetails)), this.requestUpdate();
  }
  toggleExpanded(e) {
