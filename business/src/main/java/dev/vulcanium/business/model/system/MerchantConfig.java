...
private Map<String,Boolean> useDefaultSearchConfig= new HashMap<String,Boolean>();
private Map<String,String> defaultSearchConfigPath= new HashMap<String,String>();
