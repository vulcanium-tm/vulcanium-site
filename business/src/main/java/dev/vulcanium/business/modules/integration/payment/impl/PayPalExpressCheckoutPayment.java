...
public class PayPalExpressCheckoutPayment implements PaymentModule {
	...
	public Transaction authorize(MerchantStore store, Customer customer,
		...
		dev.vulcanium.business.model.payments.PaypalPayment paypalPayment = (dev.vulcanium.business.model.payments.PaypalPayment)payment;
...
/*	@Override
	public Transaction capture(MerchantStore store, Customer customer,
		...
		dev.vulcanium.business.payments.model.PaypalPayment paypalPayment = (dev.vulcanium.business.payments.model.PaypalPayment)payment;
		Validate.notNull(paypalPayment.getPaymentToken(), "A paypal payment token is required to process this transaction");
