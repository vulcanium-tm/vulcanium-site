...
import dev.vulcanium.business.repositories.catalog.product.review.ProductReviewRepository;
...
public class ProductReviewServiceImpl extends
	...
	/* (non-Javadoc)
	 * @see dev.vulcanium.business.services.catalog.product.review.ProductReviewService#getByProductNoObjects(dev.vulcanium.business.model.catalog.product.Product)
	 */
	@Override
