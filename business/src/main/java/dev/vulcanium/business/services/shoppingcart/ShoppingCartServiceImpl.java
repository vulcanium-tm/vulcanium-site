...
import dev.vulcanium.business.repositories.shoppingcart.ShoppingCartAttributeRepository;
import dev.vulcanium.business.repositories.shoppingcart.ShoppingCartItemRepository;
import dev.vulcanium.business.repositories.shoppingcart.ShoppingCartRepository;
...
public class ShoppingCartServiceImpl extends SalesManagerEntityServiceImpl<Long, ShoppingCart>
	...
	public List<ShippingProduct> createShippingProduct(final ShoppingCart cart) throws ServiceException {
		...
		for (ShoppingCartItem item : items) {
			...
			if (!product.getProductVirtual() && product.isProductShipeable()) {
