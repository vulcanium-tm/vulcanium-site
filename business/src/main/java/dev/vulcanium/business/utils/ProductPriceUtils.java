...
public class ProductPriceUtils {
	...
	public String getFormatedAmountWithCurrency(Locale locale,
			dev.vulcanium.business.model.reference.currency.Currency currency, BigDecimal amount) throws Exception {
		if (amount == null) {
			return "";
		}
	 ...
	 */
	// Utility
	public String getFormatedAmountWithCurrency(dev.vulcanium.business.model.reference.currency.Currency currency,
