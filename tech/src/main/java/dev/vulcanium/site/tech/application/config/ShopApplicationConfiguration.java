...
public ByteArrayHttpMessageConverter byteArrayHttpMessageConverter() {
	List<MediaType> supportedMediaTypes = Arrays.asList(MediaType.IMAGE_JPEG, MediaType.IMAGE_GIF, MediaType.IMAGE_PNG, MediaType.APPLICATION_OCTET_STREAM);
...
@Bean
public HandlerInterceptor corsFilter() {
	return (HandlerInterceptor) new CorsFilter();
}
