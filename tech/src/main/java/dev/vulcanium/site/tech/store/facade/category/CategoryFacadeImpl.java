...
public List<ReadableProductVariant> categoryProductVariants(Long categoryId, MerchantStore store,
	...
	try {
		 ...
		 **/
		Map<String, List<dev.vulcanium.business.model.catalog.product.attribute.ProductOptionValue>> rawFacet = new HashMap<String, List<dev.vulcanium.business.model.catalog.product.attribute.ProductOptionValue>>();
		...
		for (ProductAttribute attr : attributes) {
			...
			List<dev.vulcanium.business.model.catalog.product.attribute.ProductOptionValue> values = rawFacet.get(attr.getProductOption().getCode());
			if (values == null) {
				values = new ArrayList<dev.vulcanium.business.model.catalog.product.attribute.ProductOptionValue>();
			...
			if(attr.getProductOptionValue() != null) {
				...
				dev.vulcanium.business.model.catalog.product.attribute.ProductOptionValue val = new dev.vulcanium.business.model.catalog.product.attribute.ProductOptionValue();
		...
		while (it.hasNext()) {
			...
			List<dev.vulcanium.business.model.catalog.product.attribute.ProductOptionValue> values = rawFacet.get(option.getCode());
			...
			if(optionDescription.isPresent()) {
				...
				for (dev.vulcanium.business.model.catalog.product.attribute.ProductOptionValue value : values) {
